...
echo "\033[32;1mAuthor : Mr.404"
echo "\033[37;1mFeat: Mr.404"
echo "\033[35;1mversion Tools: 2"
echo "\033[35;1mTeam : ANONYMOUS CYBER TEAM"
echo "\033[33;1mKontak Me :  082331072836"
echo "\033[31;1mPlease For Subcribe Youtube:MR.404"
echo "\033[92mkalimantan Cyber Team" 
...
echo "[+]===============================================[+]"
echo "\033[32;1m"
read -p "root@T00Ls-MR404V2~#" bro

if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "Mr.404" | lolcat
php tp.php
fi
...
then
clear
toilet -f standard -F gay "Mr.404" 
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "Mr404" | lolcat
figlet -f slant Mr404
echo "\033[37;1m"
...
then
clear
cowsay -f sheep.cow "Mr404" | lolcat
figlet "Mr.404" | lolcat
sleep 1
cd
cd module
...
echo "\033[32;1mauthor: Mr.404"
echo "\033[33;1mTeam: Anonymous Cyber Team"
echo "\033[34;1mIndonesia Security Lite"
echo "\033[32;1mkalimantan whitehat Army"
...
then
clear
toilet -f big -F gay "Mr.404 " | lolcat
sleep 1
...
if [ $bro = 0 ] || [ $bro = 00 ]
then
echo "\033[32;1mANNYMOUS CYBER TEAM"
sleep 1
