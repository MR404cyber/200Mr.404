...
echo "\033[32;1mAuthor : Mr.404/Muhammad Raihan"
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow Mr.404" | lolcat
...
then
clear
cowsay -f sheep.cow "Mr.404" | lolcat
figlet "Mr.404" | lolcat
sleep 1
cd
cd module
